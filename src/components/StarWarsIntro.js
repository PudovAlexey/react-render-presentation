    ...
    <Root>
      <Titles>
        <TitleContent>
          ...
          <br />
          <Typography variant="h4">
            Повстанцы часто одерживали победу, но их средства коммуникации были далеки
            от совершенства. При написании своего чата, они не пользовались методами оптимизации компонентов
            что часто оборачивалось поражением в тактических боях.
          </Typography>
          <br />
          <br />
          <Typography variant="h4">
          Основываясь на текущей комбинации изменения родительских компонентов, пропсов (props) и состояния (state),
          повстанцы сумели оптимизировать свой чат что позволило спасти галлактику от темных сил.
          </Typography>
          <br />
          <br />
          <Typography variant="h4">
