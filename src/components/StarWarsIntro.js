...
export function StarWarsIntro() {
  return (
    <Root>
      <Titles>
        <TitleContent>
          <Typography variant="h2">Эпизод I. Атомарность в React</Typography>
          ...
          <br />
          <Typography variant="h4">
            Об одном из подобных подходов сегодня и пойдет речь, Подходе,
            возможно на столько могущественном, что позволит писать супер
            производительный, красивый и хорошо расширяемый код.
          </Typography>
          <br />
          <br />
          <Typography variant="h4">
            Позаимствовав эту терминологию из химии, Брэд Фрост представил
            концепцию атомарного дизайна и использовал ее с компонентами
            пользовательского интерфейса.  Аналогично атомам, элементы
            приложения также можно представить в виде независимых блоков,
            которые должны быть самостоятельными элементами приложения, но в
            тоже время иметь свои системные связи.
          </Typography>
        </TitleContent>
      </Titles>
